...
module BookLabelModule
  ...
  def list_books
    ...
    books.each do |book|
      puts "Book publisher: #{book.publisher}", "Book cover state: #{book.cover_state}",
           "Book publish date: #{book.publish_date}"
    end
  end
